const forestLevel = new Level(
    ...
    [
        ...
        new Platforms('img/level_set/forest/Tiles/Ground_grass_0036_tile.png', 2432, 120, 30),
        new Platforms('img/level_set/forest/Tiles/Ground_grass_0035_tile.png', 2496, 120, 30),
